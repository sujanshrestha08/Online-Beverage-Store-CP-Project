...
$Beer_name=$_POST['bname'];
$Beer_volume=$_POST['bvolume'];
$Beer_brand=$_POST['bbrand'];
$Beer_category= $_POST['bcat'];
$Beer_country=$_POST['bcountry'];
$Beer_details=$_POST['bdetails'];
$Beer_price=$_POST['bprice'];
$pictureName=$_POST['party'];
...
$sql = "INSERT INTO beer VALUES (null, '$Beer_name', '$Beer_volume', '$Beer_brand', '$Beer_category', '$Beer_country', '$Beer_details', '$Beer_price', '$pic')";
...
<fieldset style="background-color: #FFE4B5;
	    ...
	    ">
			<legend id="fomhead1">Add Beer Item</legend>
			
			<p class="l">
			<label>Beer Name</label>
			<input type="text" name="bname" placeholder="Enter Name" required autofocus="autofocus" /></p>
			
			<p class="l">
			<label>Beer Volume</label>
			<input type="text" name="bvolume" placeholder="Enter Volume" required></p>
			
			<p class="l">			
			<label>Beer Brand</label>
			<input type="text" name="bbrand" placeholder="Enter Brand" required /></p>
			
			<p class="l">
			<label>Beer Category</label>
			<input type="text" name="bcat" placeholder="Enter Category" required /></p>
			
			<p class="l">
			<label>Beer Country</label>
			<input type="text" name="bcountry" placeholder="Enter Country" required/></p>
			
			<p class="l">			
			<label>Beer Details</label>
			<textarea type="text" cols="30" rows="5" name="bdetails" placeholder="Enter Details" required></textarea></p>

			<p class="l">			
			<label>Beer Price</label>
			<input type="float" name="bprice" placeholder="Enter Price" required></p>
			...
			<button type="submit" name="submit" style="color: red; border-color: green; hover: darkgreen; margin-left: 200px;" >Add Beer Item</button>

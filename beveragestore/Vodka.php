...
$Vodka_name=$_POST['vname'];
$Vodka_volume=$_POST['vvolume'];
$Vodka_brand=$_POST['vbrand'];
$Vodka_category= $_POST['vcat'];
$Vodka_country=$_POST['vcountry'];
$Vodka_details=$_POST['vdetails'];
$Vodka_price=$_POST['vprice'];
$Vodka_pic=$_POST['vpic'];
...
$sql = "INSERT INTO vodka VALUES (null, '$Vodka_name', '$Vodka_volume', '$Vodka_brand', '$Vodka_category', '$Vodka_country', '$Vodka_details', '$Vodka_price', '$pic')";
...
<fieldset style="background-color: #FFE4B5;
      ...
      ">
      <legend id="fomhead1">ADD Vodka</legend>
      
      <p class="l">
      <label>Vodka Name</label>
      <input type="text" name=vbname" placeholder="Enter Name" required autofocus="autofocus" /></p>
      
      <p class="l">
      <label>Vodka Volume</label>
      <input type="text" name="vvolume" placeholder="Enter Volume" required></p>
      
      <p class="l">     
      <label>Vodka Brand</label>
      <input type="text" name="vbrand" placeholder="Enter Brand" required /></p>
      
      <p class="l">
      <label>Vodka Category</label>
      <input type="text" name="vcat" placeholder="Enter Category" required /></p>
      
      <p class="l">
      <label>Vodka Country</label>
      <input type="text" name="vcountry" placeholder="Enter Country" required/></p>
      
      <p class="l">     
      <label>Vodka Details</label>
      <textarea type="text" cols="30" rows="5" name="vdetails" placeholder="Enter Details" required></textarea></p>

      <p class="l">     
      <label>Vodka Price</label>
      <input type="float" name="vprice" placeholder="Enter Price" required></p>
      ...
      <button type="submit" name="submit" style="color: red; border-color: green; hover: darkgreen; margin-left: 200px;" >Add Vodka Item</button>

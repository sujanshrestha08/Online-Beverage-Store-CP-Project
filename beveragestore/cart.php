      ...
      <div class="large-12">
        <?php
          ...
          if(isset($_SESSION['cart'])) {
            ...
            $result = $connect->query("SELECT product_code, product_name, product_desc, qty, price FROM products WHERE id = ".$product_id);
        ...
        <footer style="margin-top:10px;">
           <p style="text-align:center; font-size:0.8em;clear:both;">&copy; Online Beverage Store. All Rights Reserved.</p>
        </footer>

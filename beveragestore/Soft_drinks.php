...
$Soft_name=$_POST['sname'];
$Soft_volume=$_POST['svolume'];
$Soft_brand=$_POST['sbrand'];
$Soft_category= $_POST['scat'];
$Soft_country=$_POST['scountry'];
$Soft_details=$_POST['sdetails'];
$Soft_price=$_POST['sprice'];
$Soft_pic=$_POST['spic'];
...
$sql = "INSERT INTO soft_drinks VALUES (null, '$Soft_name', '$Soft_volume', '$Soft_brand', '$Soft_category', '$Soft_country', '$Soft_details', '$Soft_price', '$Soft_pic')";

$result = $connect->query($sql);
if($result){
echo "Soft Drinks Added"; 
}else{
  echo "wrong";
}
...
<fieldset style="background-color: #FFE4B5;
      ...
      ">
      <legend id="fomhead1">ADD Soft Drinks</legend>
      
      <p class="l">
      <label>Soft Name</label>
      <input type="text" name="sname" placeholder="Enter Name" required autofocus="autofocus" /></p>
      
      <p class="l">
      <label>Soft Volume</label>
      <input type="text" name="svolume" placeholder="Enter Volume" required></p>
      
      <p class="l">     
      <label>Soft Brand</label>
      <input type="text" name="sbrand" placeholder="Enter Brand" required /></p>
      
      <p class="l">
      <label>Soft Category</label>
      <input type="text" name="scat" placeholder="Enter Category" required /></p>
      
      <p class="l">
      <label>Soft Country</label>
      <input type="text" name="scountry" placeholder="Enter Country" required/></p>
      
      <p class="l">     
      <label>Soft Details</label>
      <textarea type="text" cols="30" rows="5" name="sdetails" placeholder="Enter Details" required></textarea></p>

      <p class="l">     
      <label>Soft Price</label>
      <input type="float" name="sprice" placeholder="Enter Price" required></p>
      ...
      <button type="submit" name="submit" style="color: red; border-color: green; hover: darkgreen; margin-left: 200px;" >Add Soft Drinks Item</button>

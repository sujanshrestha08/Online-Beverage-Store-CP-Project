...
<div class="row" style="margin-top:30px;">
      <div class="small-12">
        <p><h4>SignUp Page </h4></p>

        <p>Fill the details below to be registred.</p>
      </div>
    </div> 
      ...
      <div class="row">
        <div class="small-8">
          ...
          <div class="row">
            ...
            <div class="small-8 columns">
              <input type="submit" id="right-label" value="Register" style="background: #0078A0; border: none; color: #fff; font-family: 'Helvetica Neue', sans-serif; font-size: 1em; padding: 10px; margin-left: 80px;">
              <input type="reset" id="right-label" value="Reset" style="background: #0078A0; border: none; color: #fff; font-family: 'Helvetica Neue', sans-serif; font-size: 1em; padding: 10px; margin-left: 100px;">
            </div>
          </div>
        </div>
      </div>

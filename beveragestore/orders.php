    ...
    <div class="row" style="margin-top:10px;">
      <div class="large-12">
        ...
        <?php
          ...
          $result = $connect->query("SELECT * from orders where email='".$user."'");
          if($result) {
...
.suj-content button:hover {background-color: #f1f1f1}

.sujn:hover .suj-content {
    display: block;
   </style> 

    <button id = "suj" style="margin-left: 350px; background-color: #4CAF50;  ">

<a href="adminorder.php">Customer Orders</a>
</button>
